...
const Testimonials = () => {
  ...
  return (
    <section
      id="testimonial"
      className="container mx-auto px-4 flex flex-col justify-between items-center gap-10 py-20"
    >
      {/* Testimonial Content - Image and Slider */}
      ...
      <div
        ...
        data-aos="zoom-in"
        data-aos-delay="400"
        className="w-full mt-10 bg-black p-6 lg:p-16 grid grid-cols-1 lg:grid-cols-4 justify-center items-center gap-10 rounded-3xl"
      >
        {counts.map((item, index) => (
          ...
          >
            <h1 className="text-purp font-rlway text-7xl font-semibold">
              {item.value}
            </h1>
            <p className="text-white font-rlway text-xl font-semibold">
              {item.title}
            </p>
          </div>
        ))}
